    ...
    <BaseLayout>
      <View className="flex-1 bg-transparent pt-12">
        ...
        <View className="flex-row items-center justify-between px-6 mb-8 mt-4">
          ...
          <Pressable onPress={() => navigation.goBack()} className="py-2">
            <Text className="text-[#6B4EFF] font-interExtraBold text-[14px]">Save</Text>
          </Pressable>
        </View>
        ...
        <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 100 }}>
          ...
          <View className="bg-white dark:bg-slate-800/80 rounded-[32px] mx-6 p-6 shadow-sm border border-slate-100 dark:border-slate-700/50 gap-y-6">
            
            {/* Calendar Name */}
            <View>
              <Text className="text-[10px] font-interExtraBold text-[#6B4EFF] uppercase tracking-widest mb-3 pl-2">Calendar Name</Text>
              <TextInput 
            ...
            {/* Description */}
            <View>
              <Text className="text-[10px] font-interExtraBold text-[#6B4EFF] uppercase tracking-widest mb-3 pl-2">Description (Optional)</Text>
              <TextInput 
                className="border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 py-4 px-5 rounded-2xl text-black dark:text-white font-interMedium text-[15px] min-h-[100px]" 
                placeholderTextColor={isDark ? '#475569' : '#94A3B8'} 
            ...
            <View className="flex-row items-center justify-between border-t border-slate-100 dark:border-slate-700 pt-6 mt-2">
              <View className="flex-row items-center flex-1">
                <View className="w-10 h-10 rounded-full bg-[#6B4EFF]/10 items-center justify-center mr-4">
            ...
            {requirePin && (
              <Animated.View entering={FadeIn.duration(300)} exiting={FadeOut.duration(200)} className="items-center justify-center pt-2">
                <Pressable onPress={() => navigation.navigate('UnlockCalendar' as any, { intent: 'setup' })} className="flex-row items-center justify-center gap-x-4 mb-3 bg-slate-50 dark:bg-slate-900 w-full py-4 rounded-2xl border border-slate-100 dark:border-slate-800">
                  <View className="w-10 h-10 rounded-full bg-slate-200 dark:bg-slate-800 items-center justify-center"><Text className="text-slate-500 font-interExtraBold mt-1 text-[24px]">·</Text></View>
                  <View className="w-10 h-10 rounded-full bg-slate-200 dark:bg-slate-800 items-center justify-center"><Text className="text-slate-500 font-interExtraBold mt-1 text-[24px]">·</Text></View>
                  <View className="w-10 h-10 rounded-full bg-slate-200 dark:bg-slate-800 items-center justify-center"><Text className="text-slate-500 font-interExtraBold mt-1 text-[24px]">·</Text></View>
                  <View className="w-10 h-10 rounded-full bg-slate-200 dark:bg-slate-800 items-center justify-center"><Text className="text-slate-400 font-interMedium text-[20px]">-</Text></View>
                </Pressable>
                <Text className="text-[#6B4EFF] font-interExtraBold text-[10px] uppercase tracking-widest text-center">Set a security code for this calendar</Text>
              </Animated.View>
            )}
          ...
          <View className="px-6 mt-8">
            <Pressable className="bg-[#6B4EFF] py-[22px] rounded-3xl items-center flex-row justify-center shadow-lg shadow-[#6B4EFF]/30 mb-6 w-full ml-auto mr-auto max-w-[90%]">
